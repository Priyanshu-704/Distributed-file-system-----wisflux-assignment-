/**
 * Compute MD5 hash of an ArrayBuffer using the Web Crypto API (SHA-256 fallback)
 * Since Web Crypto doesn't support MD5, we use a pure JS MD5 implementation.
 */

// Minimal MD5 implementation for browser chunk hashing
...
/**
 * Format a date string to local display
 */
